...
assert_contains "${kubectl_log}" "openclaw skills setup github"
assert_contains "${kubectl_log}" "openclaw skills setup summarize"
assert_contains "${kubectl_log}" "openclaw skills setup tmux"
assert_contains "${kubectl_log}" "summarize/config.json"
