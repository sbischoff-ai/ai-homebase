...
assert_contains "${commands}" "--resolve-host memgraph.test.internal"
assert_contains "${commands}" "--resolve-host memgraph-lab.test.internal"
...
assert_contains "${output}" "Qdrant host override inside sandbox: qdrant.test.internal"
assert_contains "${output}" "Qdrant MCP host override inside sandbox: qdrant-mcp.test.internal"
...
assert_contains "${output}" "Memgraph host override inside sandbox: memgraph.test.internal"
assert_contains "${output}" "Memgraph Lab host override inside sandbox: memgraph-lab.test.internal"
