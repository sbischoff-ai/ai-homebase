...
- Pod `sysctls` are set to upstream-required forwarding defaults (`net.ipv4.ip_forward=1`, `net.ipv4.conf.all.src_valid_mark=1`) so wg-easy can bring up `wg0` consistently across deployment targets.
