...
MATRIX = [
    {
        ...
        "expect_present": {
            ...
            ("Deployment", "platform-stack-qdrant"),
            ("Ingress", "platform-stack-qdrant"),
            ("Deployment", "platform-stack-qdrant-mcp"),
            ("Ingress", "platform-stack-qdrant-mcp"),
            ("Deployment", "platform-stack-memgraph"),
            ("Ingress", "platform-stack-memgraph"),
            ("Deployment", "platform-stack-memgraph-lab"),
            ("Ingress", "platform-stack-memgraph-lab"),
        },
    },
    {
...
def assert_k3d_default_ingress_classes() -> None:
    ...
    expected = {
        ...
        "platform-stack-qdrant": "qdrant.localtest.me",
        "platform-stack-qdrant-mcp": "qdrant-mcp.localtest.me",
