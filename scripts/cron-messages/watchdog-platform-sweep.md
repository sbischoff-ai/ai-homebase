...
- No human reads a normal reply in this cron session. Do the sweep, persist the result, and stop.
...
4. Summarize findings concisely and append the result to Nextcloud `/Projects/ai-homebase/watchdog-status-log.md` with an `nc_webdav_*` tool.
