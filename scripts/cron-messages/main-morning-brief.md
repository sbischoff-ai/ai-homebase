...
2. **Budget status:** Run `tokscale --openclaw --today --json`, `tokscale --openclaw --week --json`, and `tokscale --openclaw --month --json`. Also read today's Codex usage file at `/Projects/ai-homebase/codex-usage/YYYY-MM-DD.json` if it exists. Summarize today's spend so far, this week's total, and this month's total against the $15/$50/$150 ceilings.
