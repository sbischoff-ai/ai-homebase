...
Execution rules:
- Treat `/Projects/ai-homebase/heartbeat.json`, `/Projects/ai-homebase/codex-usage/YYYY-MM-DD.json`, and `/Projects/ai-homebase/watchdog-status-log.md` as Nextcloud remote paths, not local filesystem paths.
...
If today was quiet, skip the trigger and just append a short note to `/Projects/ai-homebase/watchdog-status-log.md` with an `nc_webdav_*` tool: "YYYY-MM-DD 02:30 UTC -- activity check: quiet day, grooming skipped."
