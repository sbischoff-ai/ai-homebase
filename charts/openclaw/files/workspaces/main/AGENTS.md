...
Before routing implementation work, check whether `architect` already owns a governing artifact for the affected system. If so, route through `architect` first to validate fit and keep documentation current.
