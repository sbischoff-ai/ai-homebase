...
1. Read the relevant shared `/Desk/current.md`, `/Desk/index.md`, and local desk cues only when heartbeat or startup review genuinely needs them.
2. Check readiness.
...
6. Compare spend posture against `/Projects/ai-homebase/budget-policy.md` and treat "approaching a ceiling" as a warning signal, not an automatic emergency.
