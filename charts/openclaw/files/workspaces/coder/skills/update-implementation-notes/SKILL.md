...
4. If another agent or the user will need to rediscover the artifact later, make sure the summary includes enough path or slug detail for `/Desk/index.md` or `nc_refs` to point back to it.
